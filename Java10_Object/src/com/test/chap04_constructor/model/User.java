...
public class User {
	...
	public User(String userId, String userPwd, String userName, Date EnrollDate) {
		...
		//this() : 중복되는 동일한 초기화 하는 내용의 생성자가 존재하는 경우 this()를 사용할 수 있다.
